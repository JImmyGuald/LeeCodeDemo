 ...
 *
 * @create 2020/1/2 16:43
 */
public class LeetCodePractice0002 {
    ...
    public static String minWindow(String s, String t) {
        ...
        while(r<s.length()){
            char b = s.charAt(r);
            int tmp = map2.getOrDefault(b,0);
            map2.put(b,tmp+1);
            if(map.containsKey(b) && map2.get(b).intValue() == map.get(b).intValue()){
                count++;
            }
            while(count == map.size()&&l<=r){
                char c = s.charAt(l);
